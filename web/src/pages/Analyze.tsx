  ...
  return (
    <div className="container-narrow py-10">
      ...
      <p className="mt-2 text-textMuted">
        Wklej tekst umowy albo prześlij PDF. Po opłacie 49 zł AI analizuje umowę i pokazuje pełen raport.
      </p>
      ...
      <div className="mt-8 card p-6 bg-primary text-white">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <button
            ...
            disabled={busy}
          >
            {busy ? "Przekierowywanie do Stripe..." : "Zapłać 49 zł i sprawdź umowę"}
          </button>
        </div>
      </div>
